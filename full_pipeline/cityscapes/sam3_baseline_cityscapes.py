#!/usr/bin/env python3
"""
sam3_baseline_cityscapes.py -- STEP 1 of an arm: one SAM3 pass over the official val split.
...
Resumable: images already in val_cache (same fingerprint) are read back instead of recomputed.
    ...
    python sam3_baseline_cityscapes.py --arm llm
"""
