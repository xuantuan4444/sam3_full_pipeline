#!/usr/bin/env python3
"""
val_unetaspp_cityscapes.py -- hybrid evaluation: SAM3 baseline prediction (from val_cache) with the
...
Writes: outputs/<arm>/unetaspp/val/{summary_metrics.csv, per_class_metrics.csv,
    ...
    python val_unetaspp_cityscapes.py --arm llm
    python val_unetaspp_cityscapes.py --arm nollm --ckpt /path/to/old_best.pth   # evaluate another checkpoint
"""
