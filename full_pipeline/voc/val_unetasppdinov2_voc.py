#!/usr/bin/env python3
"""
val_unetasppdinov2_voc.py -- hybrid evaluation: SAM3 baseline prediction (from val_cache) with the
...
Writes: outputs/<arm>/unetasppdinov2/val/{summary_metrics.csv, per_class_metrics.csv,
    ...
    python val_unetasppdinov2_voc.py --arm llm
    python val_unetasppdinov2_voc.py --arm nollm --ckpt /path/to/old_best.pth   # evaluate another checkpoint
"""
